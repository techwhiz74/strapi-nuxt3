...
export interface ApiFormForm extends Schema.CollectionType {
  ...
  attributes: {
    Title: Attribute.String;
    FormFields: Attribute.Component<'form-group.form-fields'>;
    Description: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiGlobalSettingGlobalSetting extends Schema.SingleType {
  ...
  attributes: {
    ...
    SecondaryColor: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    GA4PropertyID: Attribute.String;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    Title: Attribute.String;
    Description: Attribute.Text;
    pageZone: Attribute.DynamicZone<
      [
        'pages.image',
        'pages.quote',
        'pages.rich-text',
    ...
    seo: Attribute.Component<'shared.seo'>;
    Alert: Attribute.Component<'pages.alert'>;
    Image: Attribute.Media;
